        ...
        public static void Initial(AppDBContent context)
        {
            ...
            if (!context.Products.Any())
            {
                ...
                var product1 = new Product
                {
                    ...
                    Variations =
                    [
                        new() { Size = "3050х1200х26 мм", Price = 16500.00M, DiscountedPrice = 13500.00M },
                        new() { Size = "3050х1200х38 мм", Price = 19500.00M, DiscountedPrice = 17500.00M },
                        new () { Size = "3050х600х25 мм", Price = 4850.00M, DiscountedPrice = 4250.00M },
                        new () { Size = "3050х600х38 мм", Price = 6850.00M, DiscountedPrice = 6250.00M },
                        new () { Size = "3050х800х26 мм", Price = 10500.00M },
                        new () { Size = "3050х800х38 мм", Price = 16500.00M, DiscountedPrice = 14500.00M },
                        new () { Size = "4100х600х38 мм", Price = 10500.00M, DiscountedPrice = 9500.00M }
                    ],
                    Details =
                    [
        ...
        public static Dictionary<string, Category> Categories
        {
            get
            {
                if (categories == null)
                {
                    ...
                    {
                        new() { Name = "Кедр к1" },
                        new() { Name = "Фурнитура для плинтуса KORNER 37-38 мм" }
                    };
